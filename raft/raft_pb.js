 ...
 * @return {number}
 */
proto.entries.prototype.getTerm = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.entries} returns this
 */
proto.entries.prototype.setTerm = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.entries.prototype.getMsg = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.entries} returns this
 */
proto.entries.prototype.setMsg = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
proto.AppendEntryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.entries.toObject, includeInstance),
...
proto.AppendEntryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.entries;
      reader.readMessage(value,proto.entries.deserializeBinaryFromReader);
...
proto.AppendEntryRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.entries.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.entries>}
 */
proto.AppendEntryRequest.prototype.getEntriesList = function() {
  return /** @type{!Array<!proto.entries>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.entries, 5));
};


/**
 * @param {!Array<!proto.entries>} value
 * @return {!proto.AppendEntryRequest} returns this
*/
...
/**
 * @param {!proto.entries=} opt_value
 * @param {number=} opt_index
 * @return {!proto.entries}
 */
proto.AppendEntryRequest.prototype.addEntries = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.entries, opt_index);
};
 ...
 * @return {number}
 */
proto.AppendEntryRequest.prototype.getLeaderCommit = function() {
 ...
 * @return {!proto.AppendEntryRequest} returns this
 */
proto.AppendEntryRequest.prototype.setLeaderCommit = function(value) {
 ...
 * @return {string}
 */
proto.AppendEntryReply.prototype.getNodeid = function() {
 ...
 * @return {!proto.AppendEntryReply} returns this
 */
proto.AppendEntryReply.prototype.setNodeid = function(value) {
